...
class BuySideCampaignPublisherData extends Component {
      ...
      .then(response => {
        if(response.last_updated_date!==undefined){
          ...
          this.setState({
            ...
            this.getBuySideCampignPublisherData(true);
          });
  ...
  //Get Buy Side Data
  getBuySideCampignPublisherData(date_period=null){
    let api_url = Constants.API_BASE_URL+'/buyside/publisher/?campaign_id='+this.campaign_id;
    if(date_period){
      ...
      .then(response => {
        if(response.data.length > 0){
          this.setState({
            ...
            page_title: 'BuySide Campaign - '+response.summary.campaign_name + ' - Publisher Data'
          }, ()=>{
...
export default BuySideCampaignPublisherData;